...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || START ANTIQUE CENTER</title>
  ...
  <body style="background-color:azure;">
    ...
    <form method="POST" action="update.php" style="margin-top:60px; margin-left:100px; ">
      <div class="row">
        <div class="small-12">
        <center><h3>Account Details</h3></center><br><br>

        <p><strong> If you wish to make any changes to your account details, then just enter new data and click on update.</strong></p><br>
          <div class="row">
            ...
            <div class="small-8 columns end">
              ...
              echo '<div class="row">';
              echo '<div class="small-3 columns">';
              echo '<label for="right-label" class="right inline">New Password</label>';
              echo '</div>';
              echo '<div class="small-8 columns end">';
