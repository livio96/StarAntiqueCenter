...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Password Recovery || START ANTIQUE CENTER</title>
  ...
  <body style="background-color:azure;">
    ...
    <form method="POST" action="change_password.php" style="margin-top:60px; margin-left:100px; ">
      <div class="row">
        <div class="small-12">
        <center><h3>Password Recovery Form</h3></center><br><br>

          <center><p><strong> Please, fill out all the fields below with your account information and enter your new password</strong></p> </center>
         <center><p><strong> If the information entered matches our records, your new password will be updated automatically</strong></p><br> </center>
          ...
          <div class="row">
            ...
            <div class="small-8 columns end">
              ...
              echo '</div>';
              echo '<div class="small-8 columns end">';
              echo '<input type="password" id="right-label" name="pwd" required>';
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Update Password" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
